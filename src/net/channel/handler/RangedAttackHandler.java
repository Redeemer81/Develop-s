...
public final class RangedAttackHandler extends AbstractDealDamageHandler {
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if ((attack.skill == Buccaneer.ENERGY_ORB) || (attack.skill == Aran.COMBO_SMASH) || (attack.skill == Aran.COMBO_PENRIL)) { //energy orb / aran skills
            player.getMap().broadcastMessage(player, MaplePacketCreator.rangedAttack(player.getId(), attack.skill, attack.stance, attack.numAttackedAndDamage, 0, attack.allDamage, attack.speed, attack.UNK80, attack.charge, attack.pos), false);
            ...
            if (projectile != 0 || soulArrow || attack.skill == 11101004 || attack.skill == 15111007 || attack.skill == 14101006) {
                ...
                switch (attack.skill) {
                    ...
                    case 13111002: // KoC Hurricane
                        packet = MaplePacketCreator.rangedAttack(player.getId(), attack.skill, attack.direction, attack.numAttackedAndDamage, visProjectile, attack.allDamage, attack.speed, attack.UNK80, attack.charge, attack.pos);
                        break;
                    default:
                        packet = MaplePacketCreator.rangedAttack(player.getId(), attack.skill, attack.stance, attack.numAttackedAndDamage, visProjectile, attack.allDamage, attack.speed, attack.UNK80, attack.charge, attack.pos);
                        break;
                }
                ...
                if (effect.isHomingBeacon() && attack.allDamage.size() > 0) {
