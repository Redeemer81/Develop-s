...
function action(mode, type, selection) {
    if (mode < 1)
        ...
        status++;
        if (cm.getPlayer().getMap().getId() == 910010200) {
            if (status == 0) {
                cm.sendSimple("Would you like to stop hunting and leave this place?\r\n#b#L0# Yes. I would like to leave this place.#l");
            } else if (status == 1){
                cm.warp(910010400);
                cm.dispose();
            }
            ...
            if (status == 0) {
                ...
                cm.sendSimple("What do you think about making your way there with your party members and teach those rowdy pigs a lesson?\r\n#b#L0# Yeah, that sounds good! Take me there!#l");
            } else if (status == 2) {
