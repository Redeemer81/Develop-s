...
function action(mode, type, selection) {
    ...
    if (status == 1)
        ...
        selectedMap = selection;
        cm.sendYesNo("I guess you don't need to be here. Do you really want to move to #b#m" + maps[selection] + "##k? Well it'll cost you #b" + (cost[selection] * (cm.getJobId() == 0 ? 1 : 10)) + " mesos#k. What do you think?");
    }else if (status == 4) {
