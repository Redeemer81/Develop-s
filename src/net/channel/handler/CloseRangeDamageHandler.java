...
public final class CloseRangeDamageHandler extends AbstractDealDamageHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        player.getMap().broadcastMessage(player, MaplePacketCreator.closeRangeAttack(player.getId(), attack.skill, attack.stance, attack.numAttackedAndDamage, attack.allDamage, attack.speed, attack.UNK80, attack.charge), false, true);
        ...
        if (isFinisher(attack.skill)) {
            ...
            if (attack.skill != 1111008 && comboBuff != null) {
                ...
                if (orbcount <= ceffect.getX() + 1) {
                    ...
                    c.getSession().write(MaplePacketCreator.giveBuff(oid, duration, stat, false));
                    player.getMap().broadcastMessage(player, MaplePacketCreator.giveForeignBuff(player.getId(), oid, stat, false), false);
                }
