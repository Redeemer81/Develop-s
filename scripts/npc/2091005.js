        ...
        if (mode >= 0) {
            ...
            if (selectedMenu == 0) { //I want to challenge him alone.
                ...
                if (status == 0) {
                    ...
                    var text = "In order to receive #i" + belt + "# #b#t" + belt + "##k, you have to be at least over level #b" + level + "#k and you need to have earned at least #b" + points + " training points#k.";
                    if (cm.getPlayer().getDojoPoints() > points) {
                        if (cm.getPlayer().getLevel() > level) {
                            cm.sendYesNo(text + " Looks to me like you meet the criteria. Do you wish to receive your belt now?");
                        } else
                    ...
                    cm.gainItem(belt);
                    if (belt != 1132004)
                        cm.sendNext("I will remember your faithfulness. Don't get all cocky now just because you earned a belt. The most coveted of them all is the black belt!");
                    else {
                        // I don't have enough points yet to get the black belt text
                    }
                    cm.dispose();
                }
