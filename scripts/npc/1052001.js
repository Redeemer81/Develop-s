...
function start() {
    ...
    } else if (actionx["3thJobI"] || (cm.getPlayer().gotPartyQuestItem("3") && cm.getLevel() >= 70 && cm.getJobId() % 10 == 0 && parseInt(cm.getJobId() / 100) == 4 && !cm.getPlayer().gotPartyQuestItem("P"))){
...
function action(mode, type, selection) {
    ...
    if (actionx["1stJob"]){
        if (status == 0)
            ...
            if (cm.canHold(2070015) && cm.canHold(1472061)){
                if (cm.getJobId() == 0){
