...
public final class ScrollHandler extends AbstractMaplePacketHandler {
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        scrollId = scroll.getItemId();
        itemId = toScroll.getItemId();
        ...
        c.getPlayer().getMap().broadcastMessage(MaplePacketCreator.getScrollEffect(c.getPlayer().getId(), scrollSuccess, legendarySpirit, scrollId, itemId));
