...
public final class WhisperHandler extends AbstractMaplePacketHandler {
    private static HashSet<String> gm = new HashSet<String>();
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (mode == 6) { // whisper
            ...
            if (victim != null)
            {
                if (c.getPlayer().gmLevel() >= victim.gmLevel())
                {
                    if (victim.inCS()) {
                    ...
                    try {
                        ...
                        if (channel > -1 && !gm.contains(recipient)) {
